...
alter table trip_request add constraint fk_trip_request_user_3 foreign key (user_user_id) references user (user_id) on delete restrict on update restrict;
create index ix_trip_request_user_3 on trip_request (user_user_id);
